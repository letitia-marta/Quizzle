<?php
    ...
    $insert_results_query = "
        INSERT INTO results (test_id, class_id, teacher_id, student_id, score)
        VALUES ('$test_id', '$class_id', '$teacher_id', '$student_id', '$total_score')
        ON DUPLICATE KEY UPDATE score = '$total_score'
    ";

    if (!mysqli_query($conn, $insert_results_query))
    {
...
<html lang="en">
    ...
    <body>
        ...
        <div class="test-view">
            ...
            <h2><?php echo htmlspecialchars($test['test_name']); ?> - Submission</h2>
            ...
            <p>Your Score: <?php echo $total_score; ?> / <?php echo htmlspecialchars($test['total_points']); ?></p>
